...
|----|--------|------|--------|------------|-------------|-------------|
| `tgl-ios` | iOS Style | smooth, css-only | transition, css-only | low | toggle, transition | Toggle switch "iOS Style" |
| `tgl-squircle` | Squircle | squircle, css-only | transition, squircle, css-only | low | toggle, transition, transform | Toggle switch "Squircle" |
| `tgl-pill` | Pill Toggle | minimal, css-only | transition, minimal, css-only | low | toggle, transition, transform | Toggle switch minimalista "Pill Toggle" |
| `tg-3d-toggle` | 3D Toggle | 3d, realistic, animated, css-only, toggle, industrial, led | neon, gradient, glow, animated, transition, filter, 3d, css-only, industrial | medium | toggle, animation, transition, transform | Toggle switch con efecto 3D y animado |
| `tg-day-night` | Day Night Theme | day-night, theme, sun, moon, stars, clouds, animated, css-only | neon, glow, neumorphic, transition, filter, animated, css-only | medium | hover, toggle, transition, transform | Toggle switch animado "Day Night Theme" |
