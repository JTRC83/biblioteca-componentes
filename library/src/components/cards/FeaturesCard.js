export default {
  ...
  name: 'Features Card',
  category: 'cards',
  tags: ['card', 'expand', 'hover', 'css-only', 'layered', 'layers-icon', 'neumorphic'],
  author: 'joe-watson-sbf',
  html: `<div class="jw-card">
    <div class="jw-header">
    ...
    <div class="jw-content">
        ...
        <a class="jw-btn-link">Read More...</a>
    </div>
</div>`,
  css: `
.jw-card {
...
.jw-card .jw-header .jw-img-box {
  width: 50px;
}

.jw-card .jw-header .jw-title {
  font-size: 1em;
  letter-spacing: .1em;
  font-weight: 900;
...
.jw-card:hover .jw-header {
  clip-path: polygon(0 0, 100% 0, 100% 100%, 0 96%);
}

.jw-card:hover .jw-card .jw-header .jw-title {
  padding: 0;
}
...
.jw-card .jw-content p {
  transition: all .5s;
  font-size: .8em;
  margin-bottom: 8px;
}

.jw-card .jw-content a {
  color: #1d8122;
  cursor: pointer;
  transition: all .5s;
  font-size: .7rem;
...
.jw-card .jw-content .jw-btn-link:hover {
