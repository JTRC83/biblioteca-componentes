export default {
  id: 'pat-kaleido',
  name: 'Kaleido Pattern',
  category: 'patterns',
  tags: ['kaleidoscope', 'conic', 'animated', 'hue-rotate', 'css-only'],
  author: 'mobinkakei',
  html: `<div class="pat-kaleido">
  <div class="pat-kaleido__bg"></div>
</div>`,
  css: `
.pat-kaleido {
  background: #ffffff;
...
.pat-kaleido__bg {
  ...
  background:
    ...
    conic-gradient(
      ...
      var(--ts),
    var(--c1);
  animation: pat-kaleido-colors var(--sp) linear 0s infinite;
}

@keyframes pat-kaleido-colors {
  100% {
