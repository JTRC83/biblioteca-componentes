export default {
  ...
  name: 'Hover Ripple',
  category: 'buttons',
  tags: ['ripple', 'layers', 'animated', 'css-only'],
  author: 'OliverZeros',
  html: `<button class="button button-item">
  ...
  <span class="button-inner">
    <span class="button-inner-static">Hover me</span>
    <span class="button-inner-hover">Hover me</span>
  </span>
</button>`,
  css: `
button {
