export default {
  ...
  name: 'Glass Menu Bar',
  category: 'navbars',
  tags: ['navbar', 'menu', 'bottom', 'glassmorphism', 'css-only', 'ios', 'mobile', 'frosted'],
  author: 'mymiamo',
  html: `<div class="mn-menu">
  ...
  <a href="javascript:void(0)" tabindex="0" class="active">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      fill="currentColor"
...
.mn-menu a:hover ~ a.active,
.mn-menu a:focus ~ a.active {
